...
SLLIW   -> List( Y, N, ALU_SLLW , OP_REG , OP_IMM   , IMM_I , MEM_X, WB_REG  ),
SRLIW   -> List( Y, N, ALU_SRLW , OP_REG , OP_IMM   , IMM_I , MEM_X, WB_REG  ),
SRAIW   -> List( Y, N, ALU_SRAW , OP_REG , OP_IMM   , IMM_I , MEM_X, WB_REG  ),
