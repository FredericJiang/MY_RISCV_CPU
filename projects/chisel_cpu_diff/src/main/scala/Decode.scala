...
SLLIW   -> List( Y, Y, ALU_SLLW , OP_REG , OP_X   , IMM_I , MEM_X, WB_REG ),
...
SRLI    -> List( Y, Y, ALU_SRL , OP_REG , OP_X   , IMM_I , MEM_X, WB_REG  ),
SRAI    -> List( Y, Y, ALU_SRA , OP_REG , OP_X   , IMM_I , MEM_X, WB_REG  ),
ORI     -> List( Y, Y, ALU_OR  , OP_REG , OP_X   , IMM_I , MEM_X, WB_REG  ),
ANDI    -> List( Y, Y, ALU_AND , OP_REG , OP_X   , IMM_I , MEM_X, WB_REG  ),
//load-type instruction
LB      -> List( Y, Y, ALU_ADD , OP_REG , OP_X   , IMM_I , MEM_B,  WB_REG ),
LH      -> List( Y, Y, ALU_ADD , OP_REG , OP_X   , IMM_I , MEM_H,  WB_REG ),
LW      -> List( Y, Y, ALU_ADD , OP_REG , OP_X   , IMM_I , MEM_W,  WB_REG ),
LD      -> List( Y, Y, ALU_ADD , OP_REG , OP_X   , IMM_I , MEM_D,  WB_REG ),
LBU     -> List( Y, Y, ALU_ADD , OP_REG , OP_X   , IMM_I , MEM_BU, WB_REG ),
LHU     -> List( Y, Y, ALU_ADD , OP_REG , OP_X   , IMM_I , MEM_HU, WB_REG ),
LWU     -> List( Y, Y, ALU_ADD , OP_REG , OP_X   , IMM_I , MEM_WU, WB_REG ),
//S-type
SB      -> List( Y, Y, ALU_ADD , OP_REG , OP_REG , IMM_S , MEM_X,  WB_MEM_B ),
SH      -> List( Y, Y, ALU_ADD , OP_REG , OP_REG , IMM_S , MEM_X,  WB_MEM_H ),
SW      -> List( Y, Y, ALU_ADD , OP_REG , OP_REG , IMM_S , MEM_X,  WB_MEM_W ),
SD      -> List( Y, Y, ALU_ADD , OP_REG , OP_REG , IMM_S , MEM_X,  WB_MEM_D ),
//U-type
LUI     -> List( Y, Y, ALU_X,    OP_X ,   OP_X,   IMM_U,   MEM_X, WB_REG ),
AUIPC   -> List( Y, Y, ALU_ADD,  OP_PC ,  OP_X,   IMM_U,   MEM_X, WB_REG ),
//B-type
